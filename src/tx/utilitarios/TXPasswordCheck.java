 ...
 * <p>Exemplo de como usar:</p>
        TXPasswordCheck passwordGenerator = new TXPasswordCheck.PasswordGeneratorBuilder()
                ...
                .usePunctuation(true)
                .build();
        String password = passwordGenerator.generate(10); // output ex.: lrU12fmM 75iwI90o
        System.out.println(password);
 * @author Taffarel <taffarel_deus@hotmail.com>
 */
public class TXPasswordCheck {
...
/**
 * <p style="font:16px arial">Construtor</p>
 */
    private TXPasswordCheck() {
        throw new UnsupportedOperationException("Empty constructor is not supported.");
    }

    private TXPasswordCheck(PasswordGeneratorBuilder builder) {
    ...
    public static class PasswordGeneratorBuilder {
         ...
         * object.
         */
        public TXPasswordCheck build() {
            return new TXPasswordCheck(this);
        }
    }
    ...
    /**
     * <p style="font:16px arial">Gera hash unidiracional.</p>
     * @param plainTextPassword <a>O texto para gerar o hash</a>
     * @return <p style="font:16px arial">O hash da string</p>
     */
    public static String gerarHashPassword(String plainTextPassword) {
        return BCrypt.hashpw(plainTextPassword, BCrypt.gensalt());
    }

    /**    
      <p><a>System.out.println(verificarPassword("Taffarel",gerarHashPassword("taffarel")));</a></p>
     * @param plainPassword <a>O texto de entrada do usuário</a>
     * @param hashedPassword <a>O hash para comparação</a>
     * @return <p style="font:16px arial">Retorna true se a senha estiver ok.</p>
     */
